...
//        others - reserved
// 0x10 : Data signal of Layer4_Neurons_CPU
//        bit 31~0 - Layer4_Neurons_CPU[31:0] (Read/Write)
// 0x14 : Data signal of Layer4_Neurons_CPU
//        bit 31~0 - Layer4_Neurons_CPU[63:32] (Read/Write)
// 0x18 : reserved
// (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

#define XCNN_LENET_CTRL_BUS_ADDR_AP_CTRL                 0x00
#define XCNN_LENET_CTRL_BUS_ADDR_GIE                     0x04
#define XCNN_LENET_CTRL_BUS_ADDR_IER                     0x08
#define XCNN_LENET_CTRL_BUS_ADDR_ISR                     0x0c
#define XCNN_LENET_CTRL_BUS_ADDR_LAYER4_NEURONS_CPU_DATA 0x10
#define XCNN_LENET_CTRL_BUS_BITS_LAYER4_NEURONS_CPU_DATA 64
