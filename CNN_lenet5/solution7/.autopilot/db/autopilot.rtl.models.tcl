set SynModuleInfo {
  ...
  {SRCNAME cnn_lenet_Pipeline_calculateLayer4_loop MODELNAME cnn_lenet_Pipeline_calculateLayer4_loop RTLNAME cnn_lenet_cnn_lenet_Pipeline_calculateLayer4_loop}
  {SRCNAME cnn_lenet MODELNAME cnn_lenet RTLNAME cnn_lenet IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME cnn_lenet_gmem_m_axi RTLNAME cnn_lenet_gmem_m_axi BINDTYPE interface TYPE adapter IMPL m_axi}
