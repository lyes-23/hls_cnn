set moduleName cnn_lenet_Pipeline_calculateLayer4_loop
set isTopModule 0
...
set C_modelName {cnn_lenet_Pipeline_calculateLayer4_loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ Layer3_Neurons_CPU int 32 regular {array 1250 { 1 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "Layer1_Neurons_CPU","offset": { "type": "dynamic","port_name": "Layer1_Neurons_CPU","bundle": "control"},"direction": "READONLY"},{"cName": "Layer4_Neurons_CPU","offset": { "type": "dynamic","port_name": "Layer4_Neurons_CPU","bundle": "CTRL_bus"},"direction": "WRITEONLY"}]}]} , 
...
set portList { 
	...
	{ Layer3_Neurons_CPU_q0 sc_in sc_lv 32 signal 1 } 
	{ Layer3_Neurons_CPU_address1 sc_out sc_lv 11 signal 1 } 
	{ Layer3_Neurons_CPU_ce1 sc_out sc_logic 1 signal 1 } 
	{ Layer3_Neurons_CPU_q1 sc_in sc_lv 32 signal 1 } 
	{ sext_ln70 sc_in sc_lv 62 signal 2 } 
	{ Layer3_Weights_CPU_Addr_A sc_out sc_lv 32 signal 3 } 
	{ Layer3_Weights_CPU_EN_A sc_out sc_logic 1 signal 3 } 
	{ Layer3_Weights_CPU_WEN_A sc_out sc_lv 4 signal 3 } 
	{ Layer3_Weights_CPU_Din_A sc_out sc_lv 32 signal 3 } 
	{ Layer3_Weights_CPU_Dout_A sc_in sc_lv 32 signal 3 } 
	{ Layer3_Weights_CPU_Addr_B sc_out sc_lv 32 signal 3 } 
	{ Layer3_Weights_CPU_EN_B sc_out sc_logic 1 signal 3 } 
	{ Layer3_Weights_CPU_WEN_B sc_out sc_lv 4 signal 3 } 
	{ Layer3_Weights_CPU_Din_B sc_out sc_lv 32 signal 3 } 
	{ Layer3_Weights_CPU_Dout_B sc_in sc_lv 32 signal 3 } 
	{ grp_SIGMOID_fu_171_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_SIGMOID_fu_171_p_dout0 sc_in sc_lv 32 signal -1 } 
	{ grp_SIGMOID_fu_171_p_ce sc_out sc_logic 1 signal -1 } 
	{ grp_SIGMOID_fu_171_p_start sc_out sc_logic 1 signal -1 } 
	{ grp_SIGMOID_fu_171_p_ready sc_in sc_logic 1 signal -1 } 
	{ grp_SIGMOID_fu_171_p_done sc_in sc_logic 1 signal -1 } 
	{ grp_SIGMOID_fu_171_p_idle sc_in sc_logic 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_SIGMOID_fu_171_p_din1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_SIGMOID_fu_171_p_din1", "role": "default" }} , 
 	{ "name": "grp_SIGMOID_fu_171_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_SIGMOID_fu_171_p_dout0", "role": "default" }} , 
 	{ "name": "grp_SIGMOID_fu_171_p_ce", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_SIGMOID_fu_171_p_ce", "role": "default" }} , 
 	{ "name": "grp_SIGMOID_fu_171_p_start", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_SIGMOID_fu_171_p_start", "role": "default" }} , 
 	{ "name": "grp_SIGMOID_fu_171_p_ready", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_SIGMOID_fu_171_p_ready", "role": "default" }} , 
 	{ "name": "grp_SIGMOID_fu_171_p_done", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_SIGMOID_fu_171_p_done", "role": "default" }} , 
 	{ "name": "grp_SIGMOID_fu_171_p_idle", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_SIGMOID_fu_171_p_idle", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2691", "Max" : "2691"}
	, {"Name" : "Interval", "Min" : "2691", "Max" : "2691"}
]}
...
set Spec2ImplPortList { 
	...
	Layer3_Neurons_CPU { ap_memory {  { Layer3_Neurons_CPU_address0 mem_address 1 11 }  { Layer3_Neurons_CPU_ce0 mem_ce 1 1 }  { Layer3_Neurons_CPU_q0 mem_dout 0 32 }  { Layer3_Neurons_CPU_address1 MemPortADDR2 1 11 }  { Layer3_Neurons_CPU_ce1 MemPortCE2 1 1 }  { Layer3_Neurons_CPU_q1 MemPortDOUT2 0 32 } } }
	sext_ln70 { ap_none {  { sext_ln70 in_data 0 62 } } }
	Layer3_Weights_CPU { bram {  { Layer3_Weights_CPU_Addr_A MemPortADDR2 1 32 }  { Layer3_Weights_CPU_EN_A MemPortCE2 1 1 }  { Layer3_Weights_CPU_WEN_A MemPortWE2 1 4 }  { Layer3_Weights_CPU_Din_A MemPortDIN2 1 32 }  { Layer3_Weights_CPU_Dout_A MemPortDOUT2 0 32 }  { Layer3_Weights_CPU_Addr_B MemPortADDR2 1 32 }  { Layer3_Weights_CPU_EN_B MemPortCE2 1 1 }  { Layer3_Weights_CPU_WEN_B MemPortWE2 1 4 }  { Layer3_Weights_CPU_Din_B MemPortDIN2 1 32 }  { Layer3_Weights_CPU_Dout_B MemPortDOUT2 0 32 } } }
}
