...
set solution_dir "C:/Users/TRETEC/OneDrive/Documents/Master2/HLS-FPGA/cnn_hls/CNN_lenet5/solution9"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Users/TRETEC/OneDrive/Documents/Master2/HLS-FPGA/cnn_hls/CNN_lenet5/solution9/.debug"
...
set Interfaces {
    ...
    s_axi_Layer_Neurons {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_Layer_Neurons"
        param_prefix "C_S_AXI_LAYER_NEURONS"
        addr_bits "14"
        port_width "AWADDR 14 WDATA 32 WSTRB 4 ARADDR 14 RDATA 32"
        registers {}
        memories "Layer1_Neurons_CPU {base_address 4096 range 4096} Layer3_Neurons_CPU {base_address 8192 range 8192}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_bus s_axi_Layer_Neurons"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 20 machine 64 combinational 0 latency 216925 II x}
