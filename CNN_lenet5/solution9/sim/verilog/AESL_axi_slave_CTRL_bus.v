...
parameter cnn_lenet_continue_addr = 0;
parameter cnn_lenet_auto_start_addr = 0;
...
reg  BREADY_reg = 0;
reg [DATA_WIDTH - 1 : 0] mem_CTRL_bus [CTRL_bus_DEPTH - 1 : 0] = '{default : 'h0};
reg [DATA_WIDTH-1 : 0] image_mem_CTRL_bus [ (CTRL_bus_c_bitwidth+DATA_WIDTH-1)/DATA_WIDTH * CTRL_bus_DEPTH -1 : 0] = '{default : 'hz};
