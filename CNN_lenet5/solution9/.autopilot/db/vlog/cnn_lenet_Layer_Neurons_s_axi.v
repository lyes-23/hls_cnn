...
// ==============================================================
`timescale 1ns/1ps
module cnn_lenet_Layer_Neurons_s_axi
#(parameter
    ...
    output wire                          RVALID,
    input  wire                          RREADY,
    input  wire [9:0]                    Layer1_Neurons_CPU_address0,
    input  wire                          Layer1_Neurons_CPU_ce0,
    output wire [31:0]                   Layer1_Neurons_CPU_q0,
...
//------------------------Parameter----------------------
localparam
    ADDR_LAYER1_NEURONS_CPU_BASE = 14'h1000,
    ADDR_LAYER1_NEURONS_CPU_HIGH = 14'h1fff,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [9:0]                    int_Layer1_Neurons_CPU_address0;
    wire                          int_Layer1_Neurons_CPU_ce0;
    wire [31:0]                   int_Layer1_Neurons_CPU_q0;
    wire [9:0]                    int_Layer1_Neurons_CPU_address1;
    wire                          int_Layer1_Neurons_CPU_ce1;
    wire                          int_Layer1_Neurons_CPU_we1;
    wire [3:0]                    int_Layer1_Neurons_CPU_be1;
    wire [31:0]                   int_Layer1_Neurons_CPU_d1;
    wire [31:0]                   int_Layer1_Neurons_CPU_q1;
    reg                           int_Layer1_Neurons_CPU_read;
    reg                           int_Layer1_Neurons_CPU_write;
...
cnn_lenet_Layer_Neurons_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 841 )
...
assign RVALID  = (rstate == RDDATA) & !int_Layer1_Neurons_CPU_read & !int_Layer3_Neurons_CPU_read;
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        ...
        else if (int_Layer1_Neurons_CPU_read) begin
            rdata <= int_Layer1_Neurons_CPU_q1;
        end
...
//------------------------Memory logic-------------------
// Layer1_Neurons_CPU
assign int_Layer1_Neurons_CPU_address0 = Layer1_Neurons_CPU_address0;
assign int_Layer1_Neurons_CPU_ce0      = Layer1_Neurons_CPU_ce0;
assign Layer1_Neurons_CPU_q0           = int_Layer1_Neurons_CPU_q0;
assign int_Layer1_Neurons_CPU_address1 = ar_hs? raddr[11:2] : waddr[11:2];
assign int_Layer1_Neurons_CPU_ce1      = ar_hs | (int_Layer1_Neurons_CPU_write & WVALID);
assign int_Layer1_Neurons_CPU_we1      = int_Layer1_Neurons_CPU_write & w_hs;
assign int_Layer1_Neurons_CPU_be1      = int_Layer1_Neurons_CPU_we1 ? WSTRB : 'b0;
assign int_Layer1_Neurons_CPU_d1       = WDATA;
// Layer3_Neurons_CPU
...
// int_Layer1_Neurons_CPU_read
always @(posedge ACLK) begin
    if (ARESET)
        int_Layer1_Neurons_CPU_read <= 1'b0;
    else if (ACLK_EN) begin
        if (ar_hs && raddr >= ADDR_LAYER1_NEURONS_CPU_BASE && raddr <= ADDR_LAYER1_NEURONS_CPU_HIGH)
            int_Layer1_Neurons_CPU_read <= 1'b1;
        else
            int_Layer1_Neurons_CPU_read <= 1'b0;
    end
end

// int_Layer1_Neurons_CPU_write
always @(posedge ACLK) begin
    if (ARESET)
        int_Layer1_Neurons_CPU_write <= 1'b0;
    else if (ACLK_EN) begin
        if (aw_hs && AWADDR[ADDR_BITS-1:0] >= ADDR_LAYER1_NEURONS_CPU_BASE && AWADDR[ADDR_BITS-1:0] <= ADDR_LAYER1_NEURONS_CPU_HIGH)
            int_Layer1_Neurons_CPU_write <= 1'b1;
        else if (w_hs)
            int_Layer1_Neurons_CPU_write <= 1'b0;
    end
end
...
module cnn_lenet_Layer_Neurons_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
