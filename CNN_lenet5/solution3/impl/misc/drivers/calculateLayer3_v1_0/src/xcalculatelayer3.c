...
u32 XCalculatelayer3_Get_Layer2_Weights_CPU_BaseAddress(XCalculatelayer3 *InstancePtr) {
    ...
    return (InstancePtr->Control_BaseAddress + XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_BASE);
}
...
u32 XCalculatelayer3_Get_Layer2_Weights_CPU_HighAddress(XCalculatelayer3 *InstancePtr) {
    ...
    return (InstancePtr->Control_BaseAddress + XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_HIGH);
}
...
u32 XCalculatelayer3_Get_Layer2_Weights_CPU_TotalBytes(XCalculatelayer3 *InstancePtr) {
    ...
    return (XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_HIGH - XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_BASE + 1);
}
...
u32 XCalculatelayer3_Get_Layer2_Weights_CPU_BitWidth(XCalculatelayer3 *InstancePtr) {
    ...
    return XCALCULATELAYER3_CONTROL_WIDTH_LAYER2_WEIGHTS_CPU;
}
...
u32 XCalculatelayer3_Get_Layer2_Weights_CPU_Depth(XCalculatelayer3 *InstancePtr) {
    ...
    return XCALCULATELAYER3_CONTROL_DEPTH_LAYER2_WEIGHTS_CPU;
}
...
u32 XCalculatelayer3_Write_Layer2_Weights_CPU_Words(XCalculatelayer3 *InstancePtr, int offset, word_type *data, int length) {
    ...
    if ((offset + length)*4 > (XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_HIGH - XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Control_BaseAddress + XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XCalculatelayer3_Read_Layer2_Weights_CPU_Words(XCalculatelayer3 *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Control_BaseAddress + XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XCalculatelayer3_Write_Layer2_Weights_CPU_Bytes(XCalculatelayer3 *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_HIGH - XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Control_BaseAddress + XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XCalculatelayer3_Read_Layer2_Weights_CPU_Bytes(XCalculatelayer3 *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Control_BaseAddress + XCALCULATELAYER3_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_BASE + offset + i);
    }
    return length;
}
