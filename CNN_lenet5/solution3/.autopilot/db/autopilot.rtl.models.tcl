set SynModuleInfo {
  ...
  {SRCNAME generic_tanh<double> MODELNAME generic_tanh_double_s RTLNAME calculateLayer3_generic_tanh_double_s
    SUBMODULES {
      {MODELNAME calculateLayer3_dadd_64ns_64ns_64_4_full_dsp_1 RTLNAME calculateLayer3_dadd_64ns_64ns_64_4_full_dsp_1 BINDTYPE op TYPE dadd IMPL fulldsp LATENCY 3 ALLOW_PRAGMA 1}
      {MODELNAME calculateLayer3_dsub_64ns_64ns_64_4_full_dsp_1 RTLNAME calculateLayer3_dsub_64ns_64ns_64_4_full_dsp_1 BINDTYPE op TYPE dsub IMPL fulldsp LATENCY 3 ALLOW_PRAGMA 1}
      ...
      {MODELNAME calculateLayer3_ddiv_64ns_64ns_64_17_no_dsp_1 RTLNAME calculateLayer3_ddiv_64ns_64ns_64_17_no_dsp_1 BINDTYPE op TYPE ddiv IMPL fabric LATENCY 16 ALLOW_PRAGMA 1}
  ...
  {SRCNAME calculateLayer3_Pipeline_calculateLayer3_loop MODELNAME calculateLayer3_Pipeline_calculateLayer3_loop RTLNAME calculateLayer3_calculateLayer3_Pipeline_calculateLayer3_loop
    SUBMODULES {
      ...
      {MODELNAME calculateLayer3_flow_control_loop_pipe_sequential_init RTLNAME calculateLayer3_flow_control_loop_pipe_sequential_init BINDTYPE interface TYPE internal_upc_flow_control INSTNAME calculateLayer3_flow_control_loop_pipe_sequential_init_U}
    }
  }
