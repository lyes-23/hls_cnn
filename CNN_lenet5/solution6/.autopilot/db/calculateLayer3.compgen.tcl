...
set name calculateLayer3_mul_6ns_9ns_14_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}


set name calculateLayer3_mul_3ns_6ns_8_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 0 ALLOW_PRAGMA 1
}
...
set id 15
set name calculateLayer3_mac_muladd_6ns_5ns_3ns_11_4_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 21 \
			corename calculateLayer3_CTRL_bus_axilite \
			name calculateLayer3_CTRL_bus_s_axi \
			ports {$port_CTRL_bus} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler calculateLayer3_CTRL_bus_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 22 \
			corename calculateLayer3_control_axilite \
			name calculateLayer3_control_s_axi \
			ports {$port_control} \
			op interface \
			interrupt_clear_mode TOW \
			interrupt_trigger_type default \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler calculateLayer3_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
set InstName calculateLayer3_flow_control_loop_pipe_U
set CompName calculateLayer3_flow_control_loop_pipe
