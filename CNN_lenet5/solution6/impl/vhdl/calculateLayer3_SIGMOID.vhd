...
entity calculateLayer3_SIGMOID is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of calculateLayer3_SIGMOID is 
...
attribute shreg_extract : string;
    ...
    signal select_ln12_fu_170_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln15_fu_197_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_reg_412 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_reg_412_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_reg_412_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_reg_412_pp0_iter4_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_reg_412_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_reg_412_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_1_fu_203_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_1_reg_417 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_1_reg_417_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_1_reg_417_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_1_reg_417_pp0_iter4_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_1_reg_417_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln15_1_reg_417_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_104_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_5_reg_422 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_5_reg_422_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_5_reg_422_pp0_iter4_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_5_reg_422_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_5_reg_422_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_7_reg_432 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_reg_432_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_reg_432_pp0_iter4_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_reg_432_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_reg_432_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_reg_432_pp0_iter7_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_reg_432_pp0_iter8_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln19_fu_363_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal bitcast_ln15_fu_179_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_4_fu_183_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln15_fu_193_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal or_ln15_fu_209_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln15_fu_213_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_6_fu_321_p4 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal bitcast_ln20_fu_371_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal xor_ln20_fu_375_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal and_ln19_fu_367_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal bitcast_ln20_1_fu_381_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component calculateLayer3_fpext_32ns_64_2_no_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component calculateLayer3_fcmp_32ns_32ns_1_2_no_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component calculateLayer3_SIGMOID_sigmoidLUT_1_RAM_1P_BRAM_1R1W IS
    generic (
        DataWidth : INTEGER;
...
begin
    sigmoidLUT_1_U : component calculateLayer3_SIGMOID_sigmoidLUT_1_RAM_1P_BRAM_1R1W
    generic map (
        DataWidth => 32,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    fpext_32ns_64_2_no_dsp_1_U1 : component calculateLayer3_fpext_32ns_64_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => select_ln12_fu_170_p3,
        ce => ap_const_logic_1,
        dout => grp_fu_95_p1);

    fcmp_32ns_32ns_1_2_no_dsp_1_U2 : component calculateLayer3_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U3 : component calculateLayer3_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U4 : component calculateLayer3_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    dmul_64ns_64ns_64_4_max_dsp_1_U5 : component calculateLayer3_dmul_64ns_64ns_64_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 64,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln15_1_reg_417 <= icmp_ln15_1_fu_203_p2;
                icmp_ln15_reg_412 <= icmp_ln15_fu_197_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                icmp_ln15_1_reg_417_pp0_iter2_reg <= icmp_ln15_1_reg_417;
                icmp_ln15_1_reg_417_pp0_iter3_reg <= icmp_ln15_1_reg_417_pp0_iter2_reg;
                icmp_ln15_1_reg_417_pp0_iter4_reg <= icmp_ln15_1_reg_417_pp0_iter3_reg;
                icmp_ln15_1_reg_417_pp0_iter5_reg <= icmp_ln15_1_reg_417_pp0_iter4_reg;
                icmp_ln15_1_reg_417_pp0_iter6_reg <= icmp_ln15_1_reg_417_pp0_iter5_reg;
                icmp_ln15_reg_412_pp0_iter2_reg <= icmp_ln15_reg_412;
                icmp_ln15_reg_412_pp0_iter3_reg <= icmp_ln15_reg_412_pp0_iter2_reg;
                icmp_ln15_reg_412_pp0_iter4_reg <= icmp_ln15_reg_412_pp0_iter3_reg;
                icmp_ln15_reg_412_pp0_iter5_reg <= icmp_ln15_reg_412_pp0_iter4_reg;
                icmp_ln15_reg_412_pp0_iter6_reg <= icmp_ln15_reg_412_pp0_iter5_reg;
                ...
                tmp_5_reg_422 <= grp_fu_104_p2;
                tmp_5_reg_422_pp0_iter3_reg <= tmp_5_reg_422;
                tmp_5_reg_422_pp0_iter4_reg <= tmp_5_reg_422_pp0_iter3_reg;
                tmp_5_reg_422_pp0_iter5_reg <= tmp_5_reg_422_pp0_iter4_reg;
                tmp_5_reg_422_pp0_iter6_reg <= tmp_5_reg_422_pp0_iter5_reg;
                tmp_7_reg_432 <= grp_fu_109_p2;
                tmp_7_reg_432_pp0_iter3_reg <= tmp_7_reg_432;
                tmp_7_reg_432_pp0_iter4_reg <= tmp_7_reg_432_pp0_iter3_reg;
                tmp_7_reg_432_pp0_iter5_reg <= tmp_7_reg_432_pp0_iter4_reg;
                tmp_7_reg_432_pp0_iter6_reg <= tmp_7_reg_432_pp0_iter5_reg;
                tmp_7_reg_432_pp0_iter7_reg <= tmp_7_reg_432_pp0_iter6_reg;
                tmp_7_reg_432_pp0_iter8_reg <= tmp_7_reg_432_pp0_iter7_reg;
    ...
    and_ln15_fu_213_p2 <= (tmp_5_reg_422_pp0_iter6_reg and or_ln15_fu_209_p2);
    and_ln19_fu_367_p2 <= (tmp_7_reg_432_pp0_iter8_reg and or_ln12_reg_401_pp0_iter8_reg);
    ...
    ap_return <= 
        sigmoidLUT_1_q0 when (and_ln19_fu_367_p2(0) = '1') else 
        bitcast_ln20_1_fu_381_p1;
    bitcast_ln12_1_fu_166_p1 <= xor_ln12_fu_160_p2;
    bitcast_ln12_fu_119_p1 <= x_read_reg_393;
    bitcast_ln15_fu_179_p1 <= select_ln12_fu_170_p3;
    bitcast_ln20_1_fu_381_p1 <= xor_ln20_fu_375_p2;
    bitcast_ln20_fu_371_p1 <= sigmoidLUT_1_q0;
    bitcast_ln459_fu_218_p1 <= p_op_reg_437;
    data_fu_221_p3 <= 
        ap_const_lv64_406FE00000000000 when (and_ln15_fu_213_p2(0) = '1') else 
    ...
    icmp_ln15_1_fu_203_p2 <= "1" when (trunc_ln15_fu_193_p1 = ap_const_lv23_0) else "0";
    icmp_ln15_fu_197_p2 <= "0" when (tmp_4_fu_183_p4 = ap_const_lv8_FF) else "1";
    ...
    or_ln15_fu_209_p2 <= (icmp_ln15_reg_412_pp0_iter6_reg or icmp_ln15_1_reg_417_pp0_iter6_reg);
    ...
    sigmoidLUT_1_address0 <= zext_ln19_fu_363_p1(8 - 1 downto 0);
    ...
    tmp_4_fu_183_p4 <= bitcast_ln15_fu_179_p1(30 downto 23);
    tmp_6_fu_321_p4 <= lshr_ln18_fu_309_p2(60 downto 53);
    tmp_8_fu_331_p4 <= shl_ln18_fu_315_p2(60 downto 53);
    tmp_9_fu_275_p3 <= add_ln486_fu_269_p2(11 downto 11);
    trunc_ln12_fu_132_p1 <= bitcast_ln12_fu_119_p1(23 - 1 downto 0);
    trunc_ln15_fu_193_p1 <= bitcast_ln15_fu_179_p1(23 - 1 downto 0);
    trunc_ln505_fu_247_p1 <= data_fu_221_p3(52 - 1 downto 0);
    val_fu_341_p3 <= 
        tmp_6_fu_321_p4 when (tmp_9_fu_275_p3(0) = '1') else 
        tmp_8_fu_331_p4;
    xor_ln12_fu_160_p2 <= (bitcast_ln12_fu_119_p1 xor ap_const_lv32_80000000);
    xor_ln20_fu_375_p2 <= (bitcast_ln20_fu_371_p1 xor ap_const_lv32_80000000);
    ...
    zext_ln19_fu_363_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(result_reg_442),64));
