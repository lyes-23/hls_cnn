set SynModuleInfo {
  {SRCNAME SIGMOID MODELNAME SIGMOID RTLNAME cnn_lenet_SIGMOID
    SUBMODULES {
      ...
      {MODELNAME cnn_lenet_SIGMOID_sigmoidLUT_1_RAM_1P_LUTRAM_1R1W RTLNAME cnn_lenet_SIGMOID_sigmoidLUT_1_RAM_1P_LUTRAM_1R1W BINDTYPE storage TYPE ram_1p IMPL lutram LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME cnn_lenet_Pipeline_calculateLayer2_loop_OutputRow_Loop_OutputColumn_Loop MODELNAME cnn_lenet_Pipeline_calculateLayer2_loop_OutputRow_Loop_OutputColumn_Loop RTLNAME cnn_lenet_cnn_lenet_Pipeline_calculateLayer2_loop_OutputRow_Loop_OutputColumn_Loop
    SUBMODULES {
      ...
      {MODELNAME cnn_lenet_urem_10ns_4ns_3_14_1 RTLNAME cnn_lenet_urem_10ns_4ns_3_14_1 BINDTYPE op TYPE urem IMPL auto LATENCY 13 ALLOW_PRAGMA 1}
      {MODELNAME cnn_lenet_mul_10ns_12ns_21_1_1 RTLNAME cnn_lenet_mul_10ns_12ns_21_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cnn_lenet_cnn_lenet_Pipeline_calculateLayer2_loop_OutputRow_Loop_OutputColumn_Loop_Layebkb RTLNAME cnn_lenet_cnn_lenet_Pipeline_calculateLayer2_loop_OutputRow_Loop_OutputColumn_Loop_Layebkb BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
  ...
  {SRCNAME cnn_lenet_Pipeline_calculateLayer3_loop_row_Loop_col_loop MODELNAME cnn_lenet_Pipeline_calculateLayer3_loop_row_Loop_col_loop RTLNAME cnn_lenet_cnn_lenet_Pipeline_calculateLayer3_loop_row_Loop_col_loop
    SUBMODULES {
      {MODELNAME cnn_lenet_sparsemux_15_3_32_1_1 RTLNAME cnn_lenet_sparsemux_15_3_32_1_1 BINDTYPE op TYPE sparsemux IMPL auto}
      {MODELNAME cnn_lenet_mul_6ns_9ns_14_1_1 RTLNAME cnn_lenet_mul_6ns_9ns_14_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME cnn_lenet_mul_7ns_9ns_15_1_1 RTLNAME cnn_lenet_mul_7ns_9ns_15_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME cnn_lenet_urem_7ns_4ns_3_11_1 RTLNAME cnn_lenet_urem_7ns_4ns_3_11_1 BINDTYPE op TYPE urem IMPL auto LATENCY 10 ALLOW_PRAGMA 1}
      {MODELNAME cnn_lenet_mul_9ns_11ns_19_1_1 RTLNAME cnn_lenet_mul_9ns_11ns_19_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME cnn_lenet_mul_8ns_10ns_17_1_1 RTLNAME cnn_lenet_mul_8ns_10ns_17_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME cnn_lenet_am_addmul_4ns_7ns_9ns_17_4_1 RTLNAME cnn_lenet_am_addmul_4ns_7ns_9ns_17_4_1 BINDTYPE op TYPE all IMPL dsp_slice LATENCY 3 ALLOW_PRAGMA 1}
      ...
      {MODELNAME cnn_lenet_cnn_lenet_Pipeline_calculateLayer3_loop_row_Loop_col_loop_Layer2_Weights_CPU_cud RTLNAME cnn_lenet_cnn_lenet_Pipeline_calculateLayer3_loop_row_Loop_col_loop_Layer2_Weights_CPU_cud BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME cnn_lenet MODELNAME cnn_lenet RTLNAME cnn_lenet IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME cnn_lenet_Layer_Neurons_s_axi RTLNAME cnn_lenet_Layer_Neurons_s_axi BINDTYPE interface TYPE interface_s_axilite}
    }
  }
}
