...
void XCalculatelayer3_Set_Layer2_Neurons_CPU(XCalculatelayer3 *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCalculatelayer3_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER2_NEURONS_CPU_DATA, (u32)(Data));
    XCalculatelayer3_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER2_NEURONS_CPU_DATA + 4, (u32)(Data >> 32));
}

u64 XCalculatelayer3_Get_Layer2_Neurons_CPU(XCalculatelayer3 *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCalculatelayer3_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER2_NEURONS_CPU_DATA);
    Data += (u64)XCalculatelayer3_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER2_NEURONS_CPU_DATA + 4) << 32;
    return Data;
}

void XCalculatelayer3_Set_Layer2_Weights_CPU(XCalculatelayer3 *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCalculatelayer3_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER2_WEIGHTS_CPU_DATA, (u32)(Data));
    XCalculatelayer3_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER2_WEIGHTS_CPU_DATA + 4, (u32)(Data >> 32));
}

u64 XCalculatelayer3_Get_Layer2_Weights_CPU(XCalculatelayer3 *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCalculatelayer3_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER2_WEIGHTS_CPU_DATA);
    Data += (u64)XCalculatelayer3_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER2_WEIGHTS_CPU_DATA + 4) << 32;
    return Data;
}

void XCalculatelayer3_Set_Layer3_Neurons_CPU(XCalculatelayer3 *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCalculatelayer3_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER3_NEURONS_CPU_DATA, (u32)(Data));
    XCalculatelayer3_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER3_NEURONS_CPU_DATA + 4, (u32)(Data >> 32));
}

u64 XCalculatelayer3_Get_Layer3_Neurons_CPU(XCalculatelayer3 *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCalculatelayer3_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER3_NEURONS_CPU_DATA);
    Data += (u64)XCalculatelayer3_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XCALCULATELAYER3_CTRL_BUS_ADDR_LAYER3_NEURONS_CPU_DATA + 4) << 32;
    return Data;
}
