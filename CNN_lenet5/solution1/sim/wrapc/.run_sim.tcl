...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Xilinx/2023.2/Vitis_HLS/2023.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx/2023.2/Vitis_HLS/2023.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx/2023.2/Vitis_HLS/2023.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/2023.2/Vitis_HLS/2023.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "calculateLayer3.autotvin.dat"
	set constFileTvOut       "calculateLayer3.autotvout.dat"
	set constFileHdlTvIn     "calculateLayer3.autohdltvin.dat"
	set constFileHdlTvOut    "calculateLayer3.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
