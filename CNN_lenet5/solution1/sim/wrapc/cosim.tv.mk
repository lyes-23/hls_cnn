...
$(ObjDir)/lenet_hw_tb.cpp_pre.cpp.tb.o : lenet_hw_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling lenet_hw_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/HW_CNN.cpp_pre.cpp.tb.o : HW_CNN.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling HW_CNN.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
