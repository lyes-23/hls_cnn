...
define void @apatb_calculateLayer3_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1014" "maxi" %Layer2_Neurons_CPU, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="7800" "maxi" %Layer2_Weights_CPU, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1250" "maxi" %Layer3_Neurons_CPU) local_unnamed_addr #0 {
entry:
