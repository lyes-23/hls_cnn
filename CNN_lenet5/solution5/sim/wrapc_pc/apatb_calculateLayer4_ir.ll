...
define void @apatb_calculateLayer4_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1250" "maxi" %Layer3_Neurons_CPU, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="125100" "maxi" %Layer3_Weights_CPU, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" "maxi" %Layer4_Neurons_CPU) local_unnamed_addr #0 {
entry:
