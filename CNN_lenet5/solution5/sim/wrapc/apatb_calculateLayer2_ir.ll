...
define void @apatb_calculateLayer2_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="841" "maxi" %Layer1_Neurons_CPU, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="156" %Layer1_Weights_CPU, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1014" "maxi" %Layer2_Neurons_CPU) local_unnamed_addr #0 {
entry:
  ...
  %2 = bitcast float* %Layer2_Neurons_CPU to [1014 x float]*
  call fastcc void @copy_in([841 x float]* nonnull %0, [841 x float]* nonnull align 512 %Layer1_Neurons_CPU_copy, [156 x float]* nonnull %1, [156 x float]* nonnull align 512 %Layer1_Weights_CPU_copy, [1014 x float]* nonnull %2, [1014 x float]* %Layer2_Neurons_CPU_copy)
  call void @apatb_calculateLayer2_hw([841 x float]* %Layer1_Neurons_CPU_copy, [156 x float]* %Layer1_Weights_CPU_copy, [1014 x float]* %Layer2_Neurons_CPU_copy)
  call void @copy_back([841 x float]* %0, [841 x float]* %Layer1_Neurons_CPU_copy, [156 x float]* %1, [156 x float]* %Layer1_Weights_CPU_copy, [1014 x float]* %2, [1014 x float]* %Layer2_Neurons_CPU_copy)
...
define internal fastcc void @copy_in([841 x float]* noalias readonly, [841 x float]* noalias align 512, [156 x float]* noalias readonly, [156 x float]* noalias align 512, [1014 x float]* noalias readonly, [1014 x float]* noalias) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a1014f32([1014 x float]* %5, [1014 x float]* %4)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([841 x float]* noalias, [841 x float]* noalias readonly align 512, [156 x float]* noalias, [156 x float]* noalias readonly align 512, [1014 x float]* noalias, [1014 x float]* noalias readonly) unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a1014f32([1014 x float]* %4, [1014 x float]* %5)
  ret void
}

declare void @free(i8*) local_unnamed_addr

declare void @apatb_calculateLayer2_hw([841 x float]*, [156 x float]*, [1014 x float]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([841 x float]* noalias, [841 x float]* noalias readonly align 512, [156 x float]* noalias, [156 x float]* noalias readonly align 512, [1014 x float]* noalias, [1014 x float]* noalias readonly) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a1014f32([1014 x float]* %4, [1014 x float]* %5)
  ret void
}

define void @calculateLayer2_hw_stub_wrapper([841 x float]*, [156 x float]*, [1014 x float]*) #5 {
entry:
  call void @copy_out([841 x float]* null, [841 x float]* %0, [156 x float]* null, [156 x float]* %1, [1014 x float]* null, [1014 x float]* %2)
  %3 = bitcast [841 x float]* %0 to float*
  %4 = bitcast [156 x float]* %1 to float*
  %5 = bitcast [1014 x float]* %2 to float*
  call void @calculateLayer2_hw_stub(float* %3, float* %4, float* %5)
  call void @copy_in([841 x float]* null, [841 x float]* %0, [156 x float]* null, [156 x float]* %1, [1014 x float]* null, [1014 x float]* %2)
  ret void
}

declare void @calculateLayer2_hw_stub(float*, float*, float*)
