...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "calculateLayer4.autotvin.dat"
	set constFileTvOut       "calculateLayer4.autotvout.dat"
	set constFileHdlTvIn     "calculateLayer4.autohdltvin.dat"
	set constFileHdlTvOut    "calculateLayer4.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
