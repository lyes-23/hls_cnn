...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "calculateLayer2.autotvin.dat"
	set constFileTvOut       "calculateLayer2.autotvout.dat"
	set constFileHdlTvIn     "calculateLayer2.autohdltvin.dat"
	set constFileHdlTvOut    "calculateLayer2.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
