...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.calculateLayer2.autotvin_gmem.dat"
         "c.calculateLayer2.autotvin_Layer1_Neurons_CPU.dat"
         "c.calculateLayer2.autotvin_Layer1_Weights_CPU.dat"
         "c.calculateLayer2.autotvin_Layer2_Neurons_CPU.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.calculateLayer2.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
