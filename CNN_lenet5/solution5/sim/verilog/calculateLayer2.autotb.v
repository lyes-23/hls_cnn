...
`define AUTOTB_DUT      calculateLayer2
`define AUTOTB_DUT_INST AESL_inst_calculateLayer2
`define AUTOTB_TOP      apatb_calculateLayer2_top
`define AUTOTB_LAT_RESULT_FILE "calculateLayer2.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "calculateLayer2.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_calculateLayer2_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_Layer1_Neurons_CPU 1
`define AESL_BRAM_Layer1_Weights_CPU AESL_autobram_Layer1_Weights_CPU
`define AESL_BRAM_INST_Layer1_Weights_CPU bram_inst_Layer1_Weights_CPU
`define AESL_DEPTH_Layer2_Neurons_CPU 1
`define AUTOTB_TVIN_gmem  "../tv/cdatafile/c.calculateLayer2.autotvin_gmem.dat"
`define AUTOTB_TVIN_Layer1_Neurons_CPU  "../tv/cdatafile/c.calculateLayer2.autotvin_Layer1_Neurons_CPU.dat"
`define AUTOTB_TVIN_Layer1_Weights_CPU  "../tv/cdatafile/c.calculateLayer2.autotvin_Layer1_Weights_CPU.dat"
`define AUTOTB_TVIN_Layer2_Neurons_CPU  "../tv/cdatafile/c.calculateLayer2.autotvin_Layer2_Neurons_CPU.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.calculateLayer2.autotvin_gmem.dat"
`define AUTOTB_TVIN_Layer1_Neurons_CPU_out_wrapc  "../tv/rtldatafile/rtl.calculateLayer2.autotvin_Layer1_Neurons_CPU.dat"
`define AUTOTB_TVIN_Layer1_Weights_CPU_out_wrapc  "../tv/rtldatafile/rtl.calculateLayer2.autotvin_Layer1_Weights_CPU.dat"
`define AUTOTB_TVIN_Layer2_Neurons_CPU_out_wrapc  "../tv/rtldatafile/rtl.calculateLayer2.autotvin_Layer2_Neurons_CPU.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.calculateLayer2.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.calculateLayer2.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 28541;
parameter LENGTH_Layer1_Neurons_CPU = 1;
parameter LENGTH_Layer1_Weights_CPU = 156;
parameter LENGTH_Layer2_Neurons_CPU = 1;
parameter LENGTH_gmem = 1855;
...
wire [0 : 0] gmem_BID;
wire [0 : 0] gmem_BUSER;
wire [31 : 0] Layer1_Weights_CPU_ADDR_A;
wire  Layer1_Weights_CPU_EN_A;
wire [3 : 0] Layer1_Weights_CPU_WEN_A;
wire [31 : 0] Layer1_Weights_CPU_DIN_A;
wire [31 : 0] Layer1_Weights_CPU_DOUT_A;
wire  Layer1_Weights_CPU_CLK_A;
wire  Layer1_Weights_CPU_RST_A;
wire [31 : 0] Layer1_Weights_CPU_ADDR_B;
wire  Layer1_Weights_CPU_EN_B;
wire [3 : 0] Layer1_Weights_CPU_WEN_B;
wire [31 : 0] Layer1_Weights_CPU_DIN_B;
wire [31 : 0] Layer1_Weights_CPU_DOUT_B;
wire  Layer1_Weights_CPU_CLK_B;
wire  Layer1_Weights_CPU_RST_B;
integer done_cnt = 0;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .Layer1_Weights_CPU_Addr_A(Layer1_Weights_CPU_ADDR_A),
    .Layer1_Weights_CPU_EN_A(Layer1_Weights_CPU_EN_A),
    .Layer1_Weights_CPU_WEN_A(Layer1_Weights_CPU_WEN_A),
    .Layer1_Weights_CPU_Din_A(Layer1_Weights_CPU_DIN_A),
    .Layer1_Weights_CPU_Dout_A(Layer1_Weights_CPU_DOUT_A),
    .Layer1_Weights_CPU_Clk_A(Layer1_Weights_CPU_CLK_A),
    .Layer1_Weights_CPU_Rst_A(Layer1_Weights_CPU_RST_A),
    .Layer1_Weights_CPU_Addr_B(Layer1_Weights_CPU_ADDR_B),
    .Layer1_Weights_CPU_EN_B(Layer1_Weights_CPU_EN_B),
    .Layer1_Weights_CPU_WEN_B(Layer1_Weights_CPU_WEN_B),
    .Layer1_Weights_CPU_Din_B(Layer1_Weights_CPU_DIN_B),
    .Layer1_Weights_CPU_Dout_B(Layer1_Weights_CPU_DOUT_B),
    .Layer1_Weights_CPU_Clk_B(Layer1_Weights_CPU_CLK_B),
    .Layer1_Weights_CPU_Rst_B(Layer1_Weights_CPU_RST_B));
...
//------------------------bramLayer1_Weights_CPU Instantiation--------------

// The input and output of bramLayer1_Weights_CPU
wire  bramLayer1_Weights_CPU_Clk_A, bramLayer1_Weights_CPU_Clk_B;
wire  bramLayer1_Weights_CPU_EN_A, bramLayer1_Weights_CPU_EN_B;
wire  [4 - 1 : 0] bramLayer1_Weights_CPU_WEN_A, bramLayer1_Weights_CPU_WEN_B;
wire    [31 : 0]    bramLayer1_Weights_CPU_Addr_A, bramLayer1_Weights_CPU_Addr_B;
wire    [31 : 0]    bramLayer1_Weights_CPU_Din_A, bramLayer1_Weights_CPU_Din_B;
wire    [31 : 0]    bramLayer1_Weights_CPU_Dout_A, bramLayer1_Weights_CPU_Dout_B;
wire    bramLayer1_Weights_CPU_ready;
wire    bramLayer1_Weights_CPU_done;

`AESL_BRAM_Layer1_Weights_CPU `AESL_BRAM_INST_Layer1_Weights_CPU(
    .Clk_A    (bramLayer1_Weights_CPU_Clk_A),
    .Rst_A    (bramLayer1_Weights_CPU_Rst_A),
    .EN_A     (bramLayer1_Weights_CPU_EN_A),
    .WEN_A    (bramLayer1_Weights_CPU_WEN_A),
    .Addr_A   (bramLayer1_Weights_CPU_Addr_A),
    .Din_A    (bramLayer1_Weights_CPU_Din_A),
    .Dout_A   (bramLayer1_Weights_CPU_Dout_A),
    .Clk_B    (bramLayer1_Weights_CPU_Clk_B),
    .Rst_B    (bramLayer1_Weights_CPU_Rst_B),
    .EN_B     (bramLayer1_Weights_CPU_EN_B),
    .WEN_B    (bramLayer1_Weights_CPU_WEN_B),
    .Addr_B   (bramLayer1_Weights_CPU_Addr_B),
    .Din_B    (bramLayer1_Weights_CPU_Din_B),
    .Dout_B   (bramLayer1_Weights_CPU_Dout_B),
    .ready    (bramLayer1_Weights_CPU_ready),
    .done        (bramLayer1_Weights_CPU_done)
);

// Assignment between dut and bramLayer1_Weights_CPU
assign bramLayer1_Weights_CPU_Clk_A = Layer1_Weights_CPU_CLK_A;
assign bramLayer1_Weights_CPU_Rst_A = Layer1_Weights_CPU_RST_A;
assign bramLayer1_Weights_CPU_Addr_A = Layer1_Weights_CPU_ADDR_A;
assign bramLayer1_Weights_CPU_EN_A = Layer1_Weights_CPU_EN_A;
assign Layer1_Weights_CPU_DOUT_A = bramLayer1_Weights_CPU_Dout_A;
assign bramLayer1_Weights_CPU_WEN_A = 0;
assign bramLayer1_Weights_CPU_Din_A = 0;
assign bramLayer1_Weights_CPU_Clk_B = Layer1_Weights_CPU_CLK_B;
assign bramLayer1_Weights_CPU_Rst_B = Layer1_Weights_CPU_RST_B;
assign bramLayer1_Weights_CPU_Addr_B = Layer1_Weights_CPU_ADDR_B;
assign bramLayer1_Weights_CPU_EN_B = Layer1_Weights_CPU_EN_B;
assign Layer1_Weights_CPU_DOUT_B = bramLayer1_Weights_CPU_Dout_B;
assign bramLayer1_Weights_CPU_WEN_B = 0;
assign bramLayer1_Weights_CPU_Din_B = 0;
assign bramLayer1_Weights_CPU_ready=    ready;
assign bramLayer1_Weights_CPU_done = 0;
...
reg end_Layer1_Neurons_CPU;
reg [31:0] size_Layer1_Neurons_CPU;
reg [31:0] size_Layer1_Neurons_CPU_backup;
reg end_Layer1_Weights_CPU;
reg [31:0] size_Layer1_Weights_CPU;
reg [31:0] size_Layer1_Weights_CPU_backup;
reg end_Layer2_Neurons_CPU;
reg [31:0] size_Layer2_Neurons_CPU;
reg [31:0] size_Layer2_Neurons_CPU_backup;
