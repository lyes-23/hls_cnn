...
if {[file isfile calculateLayer2.autotvin.dat]} {
	file delete -force calculateLayer2.autotvin.dat
}

if {[file isfile calculateLayer2.autotvout.dat]} {
	file delete -force calculateLayer2.autotvout.dat
}
