...
set Library     "hls"
set IPName      "calculateLayer4"
set Version     "1.0"
set DisplayName "Calculatelayer4"
set Revision    "2113913072"
...
set xo_kernel_name "calculateLayer4"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/TRETEC/OneDrive/Documents/Master2/HLS-FPGA/cnn_hls/CNN_lenet5/solution5"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Users/TRETEC/OneDrive/Documents/Master2/HLS-FPGA/cnn_hls/CNN_lenet5/solution5/.debug"
set xo_hls_files_dir ""
set hdl_module_list {calculateLayer4_mul_13s_71s_71_1_1
...
set kernel_xo ""
set detect_deadlock_json "calculateLayer4_message_dict.json"

## Variables
set Top "calculateLayer4"
set TopNoPrefix "calculateLayer4"
...
set Interfaces {
    ...
    s_axi_control {
        ...
        registers {}
        memories "Layer4_Neurons_CPU {base_address 512 range 512} Layer3_Neurons_CPU {base_address 8192 range 8192} Layer3_Weights_CPU {base_address 524288 range 524288}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_bus s_axi_control"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 20 machine 64 combinational 0 latency 2773 II x}
