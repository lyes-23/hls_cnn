...
#(parameter
    ...
    input  wire [12:0]                   Layer2_Weights_CPU_address0,
    input  wire                          Layer2_Weights_CPU_ce0,
    output wire [31:0]                   Layer2_Weights_CPU_q0
);
//------------------------Address Info-------------------
...
//------------------------Parameter----------------------
localparam
    ADDR_LAYER2_NEURONS_CPU_BASE = 16'h1000,
    ADDR_LAYER2_NEURONS_CPU_HIGH = 16'h1fff,
    ADDR_LAYER3_NEURONS_CPU_BASE = 16'h2000,
    ADDR_LAYER3_NEURONS_CPU_HIGH = 16'h3fff,
    ADDR_LAYER2_WEIGHTS_CPU_BASE = 16'h8000,
    ADDR_LAYER2_WEIGHTS_CPU_HIGH = 16'hffff,
    WRIDLE                       = 2'd0,
    WRDATA                       = 2'd1,
    WRRESP                       = 2'd2,
    WRRESET                      = 2'd3,
...
//------------------------Local signal-------------------
    ...
    wire [12:0]                   int_Layer2_Weights_CPU_address0;
    wire                          int_Layer2_Weights_CPU_ce0;
    wire [31:0]                   int_Layer2_Weights_CPU_q0;
    wire [12:0]                   int_Layer2_Weights_CPU_address1;
    wire                          int_Layer2_Weights_CPU_ce1;
    wire                          int_Layer2_Weights_CPU_we1;
    wire [3:0]                    int_Layer2_Weights_CPU_be1;
    wire [31:0]                   int_Layer2_Weights_CPU_d1;
    wire [31:0]                   int_Layer2_Weights_CPU_q1;
    reg                           int_Layer2_Weights_CPU_read;
    reg                           int_Layer2_Weights_CPU_write;
...
assign RVALID  = (rstate == RDDATA) & !int_Layer2_Neurons_CPU_read & !int_Layer3_Neurons_CPU_read & !int_Layer2_Weights_CPU_read;
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        ...
        else if (int_Layer2_Weights_CPU_read) begin
            rdata <= int_Layer2_Weights_CPU_q1;
        end
    end
end
...
// Layer2_Weights_CPU
assign int_Layer2_Weights_CPU_address0 = Layer2_Weights_CPU_address0;
assign int_Layer2_Weights_CPU_ce0      = Layer2_Weights_CPU_ce0;
assign Layer2_Weights_CPU_q0           = int_Layer2_Weights_CPU_q0;
assign int_Layer2_Weights_CPU_address1 = ar_hs? raddr[14:2] : waddr[14:2];
assign int_Layer2_Weights_CPU_ce1      = ar_hs | (int_Layer2_Weights_CPU_write & WVALID);
assign int_Layer2_Weights_CPU_we1      = int_Layer2_Weights_CPU_write & w_hs;
assign int_Layer2_Weights_CPU_be1      = int_Layer2_Weights_CPU_we1 ? WSTRB : 'b0;
assign int_Layer2_Weights_CPU_d1       = WDATA;
...
// int_Layer2_Weights_CPU_read
always @(posedge ACLK) begin
    if (ARESET)
        int_Layer2_Weights_CPU_read <= 1'b0;
    else if (ACLK_EN) begin
        if (ar_hs && raddr >= ADDR_LAYER2_WEIGHTS_CPU_BASE && raddr <= ADDR_LAYER2_WEIGHTS_CPU_HIGH)
            int_Layer2_Weights_CPU_read <= 1'b1;
        else
            int_Layer2_Weights_CPU_read <= 1'b0;
    end
end

// int_Layer2_Weights_CPU_write
always @(posedge ACLK) begin
    if (ARESET)
        int_Layer2_Weights_CPU_write <= 1'b0;
    else if (ACLK_EN) begin
        if (aw_hs && AWADDR[ADDR_BITS-1:0] >= ADDR_LAYER2_WEIGHTS_CPU_BASE && AWADDR[ADDR_BITS-1:0] <= ADDR_LAYER2_WEIGHTS_CPU_HIGH)
            int_Layer2_Weights_CPU_write <= 1'b1;
        else if (w_hs)
            int_Layer2_Weights_CPU_write <= 1'b0;
    end
end
