set SynModuleInfo {
  {SRCNAME exp_generic<double> MODELNAME exp_generic_double_s RTLNAME calculateLayer3_exp_generic_double_s
    SUBMODULES {
      {MODELNAME calculateLayer3_mul_13s_71s_71_1_1 RTLNAME calculateLayer3_mul_13s_71s_71_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateLayer3_mul_43ns_36ns_79_1_1 RTLNAME calculateLayer3_mul_43ns_36ns_79_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateLayer3_mul_49ns_44ns_93_1_1 RTLNAME calculateLayer3_mul_49ns_44ns_93_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateLayer3_mul_50ns_50ns_100_1_1 RTLNAME calculateLayer3_mul_50ns_50ns_100_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
  ...
  {SRCNAME generic_tanh<double> MODELNAME generic_tanh_double_s RTLNAME calculateLayer3_generic_tanh_double_s
    SUBMODULES {
      {MODELNAME calculateLayer3_dadddsub_64ns_64ns_64_4_full_dsp_1 RTLNAME calculateLayer3_dadddsub_64ns_64ns_64_4_full_dsp_1 BINDTYPE op TYPE dadd IMPL fulldsp LATENCY 3 ALLOW_PRAGMA 1}
      ...
      {MODELNAME calculateLayer3_ddiv_64ns_64ns_64_14_no_dsp_1 RTLNAME calculateLayer3_ddiv_64ns_64ns_64_14_no_dsp_1 BINDTYPE op TYPE ddiv IMPL fabric LATENCY 13 ALLOW_PRAGMA 1}
  ...
  {SRCNAME calculateLayer3 MODELNAME calculateLayer3 RTLNAME calculateLayer3 IS_TOP 1
    SUBMODULES {
      {MODELNAME calculateLayer3_fadd_32ns_32ns_32_3_full_dsp_1 RTLNAME calculateLayer3_fadd_32ns_32ns_32_3_full_dsp_1 BINDTYPE op TYPE fadd IMPL fulldsp LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME calculateLayer3_fptrunc_64ns_32_1_no_dsp_1 RTLNAME calculateLayer3_fptrunc_64ns_32_1_no_dsp_1 BINDTYPE op TYPE fptrunc IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateLayer3_fpext_32ns_64_1_no_dsp_1 RTLNAME calculateLayer3_fpext_32ns_64_1_no_dsp_1 BINDTYPE op TYPE fpext IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME calculateLayer3_dmul_64ns_64ns_64_4_max_dsp_1_x RTLNAME calculateLayer3_dmul_64ns_64ns_64_4_max_dsp_1_x BINDTYPE op TYPE dmul IMPL maxdsp LATENCY 3 ALLOW_PRAGMA 1}
