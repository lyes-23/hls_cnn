...
set C_modelArgList {
	...
	{ Layer2_Weights_CPU int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "Layer_Weights", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "Layer1_Weights_CPU","offset": { "type": "dynamic","port_name": "Layer1_Weights_CPU","bundle": "control"},"direction": "READONLY"},{"cName": "Layer2_Weights_CPU","offset": { "type": "dynamic","port_name": "Layer2_Weights_CPU","bundle": "control"},"direction": "READONLY"},{"cName": "Layer3_Weights_CPU","offset": { "type": "dynamic","port_name": "Layer3_Weights_CPU","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "Layer2_Weights_CPU", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ Layer2_Weights_CPU sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Layer2_Weights_CPU", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Layer2_Weights_CPU", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_6ns_11ns_16_1_1_U28", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_3ns_6ns_8_1_1_U29", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_6ns_5ns_3ns_11_4_1_U30", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "190475", "Max" : "190475"}
	, {"Name" : "Interval", "Min" : "190475", "Max" : "190475"}
]}
...
set Spec2ImplPortList { 
	...
	Layer2_Weights_CPU { ap_none {  { Layer2_Weights_CPU in_data 0 64 } } }
