...
define void @apatb_cnn_lenet_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="841" "maxi" %Layer1_Neurons_CPU, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1014" %Layer2_Neurons_CPU, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1250" %Layer3_Neurons_CPU, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="156" "maxi" %Layer1_Weights_CPU, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="7800" "maxi" %Layer2_Weights_CPU, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="125100" "maxi" %Layer3_Weights_CPU, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" "maxi" %Layer4_Neurons_CPU) local_unnamed_addr #0 {
entry:
