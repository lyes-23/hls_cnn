...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cnn_lenet.autotvin.dat"
	set constFileTvOut       "cnn_lenet.autotvout.dat"
	set constFileHdlTvIn     "cnn_lenet.autohdltvin.dat"
	set constFileHdlTvOut    "cnn_lenet.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
