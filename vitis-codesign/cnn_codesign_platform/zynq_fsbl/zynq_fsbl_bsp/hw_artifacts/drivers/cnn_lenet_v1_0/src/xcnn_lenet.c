...
void XCnn_lenet_Set_Layer1_Weights_CPU(XCnn_lenet *InstancePtr, u64 Data) {
    ...
    XCnn_lenet_WriteReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER1_WEIGHTS_CPU_DATA, (u32)(Data));
    XCnn_lenet_WriteReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER1_WEIGHTS_CPU_DATA + 4, (u32)(Data >> 32));
}
...
u64 XCnn_lenet_Get_Layer1_Weights_CPU(XCnn_lenet *InstancePtr) {
    ...
    Data = XCnn_lenet_ReadReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER1_WEIGHTS_CPU_DATA);
    Data += (u64)XCnn_lenet_ReadReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER1_WEIGHTS_CPU_DATA + 4) << 32;
    return Data;
}
...
void XCnn_lenet_Set_Layer2_Weights_CPU(XCnn_lenet *InstancePtr, u64 Data) {
    ...
    XCnn_lenet_WriteReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_DATA, (u32)(Data));
    XCnn_lenet_WriteReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_DATA + 4, (u32)(Data >> 32));
}
...
u64 XCnn_lenet_Get_Layer2_Weights_CPU(XCnn_lenet *InstancePtr) {
    ...
    Data = XCnn_lenet_ReadReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_DATA);
    Data += (u64)XCnn_lenet_ReadReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER2_WEIGHTS_CPU_DATA + 4) << 32;
    return Data;
}
...
void XCnn_lenet_Set_Layer3_Weights_CPU(XCnn_lenet *InstancePtr, u64 Data) {
    ...
    XCnn_lenet_WriteReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER3_WEIGHTS_CPU_DATA, (u32)(Data));
    XCnn_lenet_WriteReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER3_WEIGHTS_CPU_DATA + 4, (u32)(Data >> 32));
}
...
u64 XCnn_lenet_Get_Layer3_Weights_CPU(XCnn_lenet *InstancePtr) {
    ...
    Data = XCnn_lenet_ReadReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER3_WEIGHTS_CPU_DATA);
    Data += (u64)XCnn_lenet_ReadReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER3_WEIGHTS_CPU_DATA + 4) << 32;
    return Data;
}
...
void XCnn_lenet_Set_Layer4_Neurons_CPU(XCnn_lenet *InstancePtr, u64 Data) {
    ...
    XCnn_lenet_WriteReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER4_NEURONS_CPU_DATA, (u32)(Data));
    XCnn_lenet_WriteReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER4_NEURONS_CPU_DATA + 4, (u32)(Data >> 32));
}
...
u64 XCnn_lenet_Get_Layer4_Neurons_CPU(XCnn_lenet *InstancePtr) {
    ...
    Data = XCnn_lenet_ReadReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER4_NEURONS_CPU_DATA);
    Data += (u64)XCnn_lenet_ReadReg(InstancePtr->Control_BaseAddress, XCNN_LENET_CONTROL_ADDR_LAYER4_NEURONS_CPU_DATA + 4) << 32;
    return Data;
}
